...
import SegmentsAltura from "@/components/v2/SegmentsAltura";
import { alturaClientLogos } from "@/data/clientLogosAltura";
...
/**
 * Altura v2 — cópia de validação (reunião 04/08/2026).
 * Página original em `/altura` permanece intacta.
 */
export default function AlturaV2Page() {
    return (
        <main className="min-h-screen bg-jvs-bg-alt font-sans">
            ...
            <section className="relative bg-gradient-hero text-white overflow-hidden py-28 md:py-36">
                <div className="absolute inset-0 bg-[url('/bg-altura.jpg')] bg-cover bg-center opacity-20" />
                <div className="absolute inset-0 bg-gradient-to-t from-jvs-navy via-jvs-navy/40 to-transparent" />
                <div className="absolute -top-32 -right-32 w-96 h-96 bg-jvs-gold/10 rounded-full blur-[110px] pointer-events-none" />
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        ...
                        <span className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-jvs-gold/15 text-jvs-gold-light text-sm font-semibold mb-8 border border-jvs-gold/30">
                            ...
                            Especialistas em acesso por corda
                        </span>
                        ...
                        <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed">
                            ...
                            Equipe certificada com experiência em acesso por corda e documentação para
                    ...
                    >
                        {[
                            ...
                            return (
                                <div
                                    key={i}
                                    className="flex flex-col items-center justify-center text-center gap-2 py-8 px-4"
                                >
                                    ...
                                    <span className="text-3xl md:text-4xl font-extrabold text-jvs-navy">
                                        {stat.value}
                                    </span>
                                    <span className="text-xs font-bold text-jvs-muted uppercase tracking-wider">
                                        {stat.label}
                                    </span>
                                </div>
                            );
            ...
            {/* Clientes cedo (vitrine) */}
            <div className="pt-16">
                <ClientsShowcase
                    title="Quem confia na JVS para limpeza em altura"
                    subtitle=""
                    eyebrow=""
                    logos={alturaClientLogos}
                    tone="light"
                />
            </div>
            ...
            {/* Soluções */}
            <section className="pt-20 pb-20 md:pt-24 md:pb-28 bg-white">
                <div className="container mx-auto px-4">
                    <motion.div {...fadeUp} className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-jvs-navy mb-4 tracking-tight">
                            Nossas Soluções em Altura
                        </h2>
                        <div className="w-16 h-1 bg-jvs-gold mx-auto mb-5 rounded-full" />
                        <p className="text-jvs-muted max-w-2xl mx-auto leading-relaxed text-lg">
                            Técnicas especializadas para cada tipo de estrutura, garantindo limpeza profunda
                            sem danificar superfícies.
                        </p>
                    </motion.div>
            ...
            {/* Diferenciais — reforço homologação */}
            <section className="py-20 md:py-28 bg-jvs-bg-alt">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-jvs-gold/10 rounded-full blur-[90px] pointer-events-none" />

                        <div className="relative flex flex-col lg:flex-row">
                            <div className="relative lg:w-[38%] h-64 lg:h-auto shrink-0">
                                <img
                                    src="/images/altura/diferenciais.jpg"
                                    alt="Equipe JVS com equipamentos de segurança e documentação para trabalho em altura"
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="relative p-8 md:p-14 md:pb-10">
                                    ...
                                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-5 max-w-2xl leading-tight tracking-tight">
                                        Segurança Rigorosa e
                                        <br />
                                        Documentação para Homologar
                                    </h2>
                                    <p className="text-slate-300 text-lg leading-relaxed max-w-2xl">
                                        Não arrisque sua responsabilidade civil. Trabalhamos com a documentação
                                        necessária para entrar e operar em grandes clientes — ASOs, liberações e
                                        treinamentos em dia.
                                    </p>
                                </div>
                                ...
                                <div className="relative px-8 md:px-14 border-t border-white/10 divide-y divide-white/10">
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 py-7 -mx-4 px-4 rounded-lg hover:bg-white/[0.03] transition-colors">
                                        <div className="flex items-center gap-4 sm:w-1/3 shrink-0">
                                            ...
                                            <h4 className="font-bold text-lg">Acesso por corda certificado</h4>
                                        </div>
                                        <p className="text-slate-300 text-sm leading-relaxed sm:w-2/3">
                                            Equipe 100% treinada e atualizada (incluindo requisitos NR-35), com
                                            procedimentos e EPIs controlados.
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 py-7 -mx-4 px-4 rounded-lg hover:bg-white/[0.03] transition-colors">
                                        <div className="flex items-center gap-4 sm:w-1/3 shrink-0">
                                            ...
                                            <h4 className="font-bold text-lg">Homologação em grandes clientes</h4>
                                        </div>
                                        <p className="text-slate-300 text-sm leading-relaxed sm:w-2/3">
                                            Documentação completa para homologar: ASOs, liberações, seguros e
                                            evidências de conformidade — prontos para o setor de suprimentos.
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 py-7 -mx-4 px-4 rounded-lg hover:bg-white/[0.03] transition-colors">
                                        ...
                                        <p className="text-slate-300 text-sm leading-relaxed sm:w-2/3">
                                            Orçamento detalhado sem custos ocultos. Documentação técnica completa.
                                        </p>
                                    </div>
                                </div>
                            </div>
